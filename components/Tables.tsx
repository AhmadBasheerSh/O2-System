            ...
            {filteredTables.map(table => {
              ...
              return (
                <motion.button
                  ...
                  } ${config.color} ${config.border} text-white shadow-xl`}
                >
              ...
              {filteredTables.map(table => {
                ...
                return (
                  <motion.button
                    ...
                    } ${config.color} ${config.border} text-white`}
                  >
                  ...
                  <div className="space-y-6">
                    <div className="grid grid-cols-2 gap-4">
                      <div className="bg-slate-800/50 p-4 rounded-2xl border border-white/5">
                        ...
                        <p className="text-lg font-black text-white">{activePopupTable.capacity} أشخاص</p>
                      </div>
                      <div className="bg-slate-800/50 p-4 rounded-2xl border border-white/5">
                        <div className="flex items-center gap-2 text-slate-500 mb-1">
                          <Clock size={14} />
                    ...
                    <div className="bg-slate-800/50 p-6 rounded-3xl border border-white/5 flex flex-col gap-4">
                      <div className="flex justify-between items-center">
                        ...
                        <button 
                          onClick={() => { loadOrderToPOS(activePopupOrder); onSelect(activePopupTable); }}
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      ...
                      <button 
                        className="flex flex-col items-center gap-2 p-4 bg-slate-800 rounded-2xl border border-white/5 hover:bg-slate-700 transition-all opacity-50 cursor-not-allowed"
                        title="قيد التطوير"
                      >
                        <Split size={20} className="text-orange-500" />
                        <span className="text-[10px] font-black text-slate-300">تقسيم</span>
                      </button>
                    </div>
                  </div>
                ) : (
                  <div className="space-y-6">
                    ...
                    <div className="flex flex-col gap-3">
                      ...
                      <div className="flex gap-3">
                        ...
                        <button 
                          onClick={() => { setSelectedTable(activePopupTable); onSelect(activePopupTable); }}
                          className="flex-1 bg-slate-800 text-white py-4 rounded-2xl font-black text-sm"
                        >
                          فتح طلب جديد
                        </button>
                      </div>
